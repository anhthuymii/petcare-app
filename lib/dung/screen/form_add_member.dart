...
class FormAddPet extends StatefulWidget {
  ...
  @override
  State<FormAddPet> createState() => _FormAddPetState();

}
class _FormAddPetState extends State<FormAddPet> {

  add(ProductDataModel productDataModel) async {
    await MemberService().addMember(productDataModel).then((success) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar:AppBar(
          title: const Center(
            child: Text('Thêm Thông Tin Thú Cưng',
              style: TextStyle(
                fontSize: 25,
                color: Colors.white,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: const Text("Thông tin thú cưng mới",style: TextStyle(
  ...
  Future<void>takePhoto(ImageSource source) async {
    final path = Image.asset('assets/Images/cat2.png');
    final pickedImage =
